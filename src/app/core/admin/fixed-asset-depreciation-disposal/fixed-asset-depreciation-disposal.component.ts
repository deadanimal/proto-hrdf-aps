...
@Component({
  selector: "app-fixed-asset-depreciation-disposal",
  templateUrl: "./fixed-asset-depreciation-disposal.component.html",
  styleUrls: ["./fixed-asset-depreciation-disposal.component.scss"],
})
export class FixedAssetDepreciationDisposalComponent implements OnInit {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
