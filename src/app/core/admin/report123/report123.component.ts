...
@Component({
  selector: 'app-report123',
  templateUrl: './report123.component.html',
  styleUrls: ['./report123.component.scss']
})
export class Report123Component implements OnInit, OnDestroy {
  ...
  getChart() {
    let chart = am4core.create("chartreportdiv1", am4charts.XYChart);
  ...
  getChart1() {
    let chart = am4core.create("chartreportdiv2", am4charts.XYChart);
  ...
  getChart2() {
    let chart = am4core.create("chartreportdiv3", am4charts.XYChart);
  ...
  getChart3() {
    let chart = am4core.create("chartreportdiv4", am4charts.XYChart);
