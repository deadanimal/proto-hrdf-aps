...
@Component({
  ...
  templateUrl: "./fixed-asset-registration.component.html",
  styleUrls: ["./fixed-asset-registration.component.scss"],
})
export class FixedAssetRegistrationComponent implements OnInit, OnDestroy {
  // Chart
  private chart1: any;
  private chart2: any;
  private chart3: any;
